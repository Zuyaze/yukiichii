            ...
            <div className="sticky top-24 space-y-6">
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <input type="text" placeholder="Cari aplikasi..." value={search} onChange={e => {debouncedSearch(e.target.value)(); setSearch(e.target.value); setPage(1)}} className="pl-10 pr-10 w-full h-10 px-4 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
