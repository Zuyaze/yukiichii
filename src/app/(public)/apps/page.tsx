            ...
            <div className="sticky top-24 space-y-6">
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <input type="text" placeholder="Cari aplikasi..." value={search} onChange={handleSearch} className="pl-10 pr-10 w-full h-10 px-4 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
                ...
                <div className="space-y-2">
                  <select value={category} onChange={e => {handleCategoryChange(e.target.value)}} className="w-full h-10 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"><option value="">Semua Kategori</option></select>
                  <div>
